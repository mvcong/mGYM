...
public class ThongBao implements Comparable<ThongBao> {
	...
	public ThongBao(String maTB, String tenTB, Date ngayTao, String link, String noiDung, NhanVien nhanVien,
	...
	public String toString() {
		return "ThongBao [maTB=" + maTB + ", tenTB=" + tenTB + ", ngayTao=" + ngayTao + ", link=" + link + ", noiDung="
				+ noiDung + ", nhanVien=" + nhanVien + ", thoiGianCapNhat=" + thoiGianCapNhat + "]";
	}

	@Override
	public int compareTo(ThongBao o) {
		// TODO Auto-generated method stub
		return this.maTB.compareTo(o.maTB);
	}
