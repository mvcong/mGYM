...
@Entity
public class PhieuGiamSatTV implements Comparable<PhieuGiamSatTV> {
	...
	public PhieuGiamSatTV(String maPGS, String tenPGS, Date ngayBD, Date ngayKT, String noiDung, ThanhVien thanhVien,
			NhanVien nhanVien, Date thoiGianCapNhat) {
		super();
		this.maPGS = maPGS;
		this.tenPGS = tenPGS;
		this.ngayBD = ngayBD;
	...
	public String toString() {
		return "PhieuGiamSatTV [maPGS=" + maPGS + ", tenPGS=" + tenPGS + ", ngayBD=" + ngayBD + ", ngayKT=" + ngayKT
				+ ", noiDung=" + noiDung + ", thanhVien=" + thanhVien + ", nhanVien=" + nhanVien + ", thoiGianCapNhat="
				+ thoiGianCapNhat + "]";
	}

	@Override
	public int compareTo(PhieuGiamSatTV o) {
		// TODO Auto-generated method stub
		return this.maPGS.compareTo(o.maPGS);
	}
