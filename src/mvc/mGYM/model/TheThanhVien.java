...
@Entity
public class TheThanhVien implements Comparable<TheThanhVien> {
	...
	public TheThanhVien(String maThe, Date ngayTao, Date ngayKT, String hsd, String loaiThe, ThanhVien thanhVien,
	...
	public String toString() {
		return "TheThanhVien [maThe=" + maThe + ", ngayTao=" + ngayTao + ", ngayKT=" + ngayKT + ", hsd=" + hsd
				+ ", loaiThe=" + loaiThe + ", thanhVien=" + thanhVien + ", thoiGianCapNhat=" + thoiGianCapNhat + "]";
	}

	@Override
	public int compareTo(TheThanhVien o) {
		// TODO Auto-generated method stub
		return this.maThe.compareTo(o.maThe);
	}
}
