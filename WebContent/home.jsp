...
<!-- Bootstrap core CSS -->
<link href="content/css_scripts/bootstrap/css/bootstrap.min.css" rel="stylesheet"> 
<!-- Custom styles for this template -->
<link href="content/css_scripts/bootstrap/css/custom.css" rel="stylesheet">

<!-- Helper Styles -->
<link href="content/css_scripts/bootstrap/css/loaders.css" rel="stylesheet">
<link href="content/css_scripts/bootstrap/css/swiper.min.css" rel="stylesheet">
<link rel="stylesheet" href="content/css_scripts/bootstrap/css/animate.min.css">
<link rel="stylesheet" href="content/css_scripts/bootstrap/css/nivo-lightbox.css">
<link rel="stylesheet" href="content/css_scripts/bootstrap/css/nivo_themes/default/default.css">
<!-- Font Awesome Style -->
<link href="content/css_scripts/font-awesome/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
</head>
<body>
...
<div class="swiper-container main-slider" id="myCarousel">
  <div class="swiper-wrapper">
    <div class="swiper-slide slider-bg-position" style="background:url('content/img/1.jpg')" data-hash="slide1">
      <h2>It is health that is real wealth and not pieces of gold and silver</h2>
    </div>
    <div class="swiper-slide slider-bg-position" style="background:url('content/img/3.jpg')" data-hash="slide2">
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4"> <img src="content/img/side-01.jpg" class="img-fluid" /> </div>
    </div>
    <!-- /.row --> 
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="heading text-md-center text-xs-center">
      ...
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/img/blog-01.jpg" alt="" class="img-fluid"> </div>
      ...
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/img/blog-02.jpg" alt="" class="img-fluid"> </div>
        <h3 class="blog-title"><small>Benefits</small><a href="#">Happiness is nothing more than good health</a></h3>
        <p class="blog-content">Our greatest happiness does not depend on the condition of life</p>
      </div>
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/img/blog-03.jpg" alt="" class="img-fluid"> </div>
          ...
          <div class="iso-box-section wow fadeInUp" data-wow-delay="0.9s">
            <div class="iso-box-wrapper col4-iso-box">
              <div class="iso-box london paris ny col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-01.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-01.jpg" class="fluid-img" alt="Gallery">
              ...
              <div class="iso-box london ny hn col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-02.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-02.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box hn col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-03.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-03.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box london col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-04.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-04.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box ny col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-05.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-05.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box paris lunch col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/img/photo-gallery-06.jpg" data-lightbox-gallery="food-gallery"> <img src="content/img/photo-gallery-06.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
...
<script src="content/css_scripts/bootstrap/js/jquery.min.js" ></script> 
<script src="content/css_scripts/bootstrap/js/bootstrap.min.js"></script> 
<script src="content/css_scripts/bootstrap/js/scrollPosStyler.js"></script> 
<script src="content/css_scripts/bootstrap/js/swiper.min.js"></script> 
<script src="content/css_scripts/bootstrap/js/isotope.min.js"></script> 
<script src="content/css_scripts/bootstrap/js/nivo-lightbox.min.js"></script> 
<script src="content/css_scripts/bootstrap/js/wow.min.js"></script> 
<script src="content/css_scripts/bootstrap/js/core.js"></script> 
